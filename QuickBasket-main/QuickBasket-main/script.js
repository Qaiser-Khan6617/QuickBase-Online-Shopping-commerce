...
function createProductCard(product) {
  ...
  productCard.innerHTML = `
      <img src="${product.image}" alt="${product.name}" class="product-image skeleton" onload="this.classList.remove('skeleton')" onerror="this.onerror=null; this.src='images/placeholder.png'; this.classList.remove('skeleton')">
    ...
    cart.forEach((item) => {
      ...
      cartItem.innerHTML = `
                <div class="cart-item-info">
                    <img src="${item.image}" alt="${item.name}" class="cart-item-image" onerror="this.onerror=null; this.src='images/placeholder.png';">
        ...
        : "Product details unavailable.";
          ...
          wishlistItem.innerHTML = `
              <div class="wishlist-item-info">
                <img src="${item.image}" alt="${item.name}" class="wishlist-item-image" onerror="this.onerror=null; this.src='images/placeholder.png';">
